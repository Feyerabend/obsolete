...
public class Context {
  ...
  public void assign(VariableExp n, boolean v) {
    b.insert(new ListNode(n.toString(), new Boolean(v)));
  }
  public boolean lookup(String n) {
    return ((Boolean) b.search(n)).booleanValue();
  }
}
